...
class KChatTimer extends StatefulWidget {
  ...
  @override
  State<KChatTimer> createState() => _KChatTimerState();
}

class _KChatTimerState extends State<KChatTimer> {
  late Timer _timer;
  ...
  @override
  void didUpdateWidget(KChatTimer oldWidget) {
