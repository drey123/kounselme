...
class AppIcons {
  ...
  static IconData get file => Symbols.description_rounded;
  ...
  static IconData get thinking =>
      Symbols.psychology_rounded; // For AI thinking indicator
  static IconData get brain =>
      Symbols.cognition_rounded; // For AI deep thinking
  ...
  static IconData navBar(IconData icon) {
    return getWithProperties(icon: icon, weight: 500, fill: 1, opticalSize: 24);
  }

  // Action icons - bold but not filled
  static IconData action(IconData icon) {
    return getWithProperties(icon: icon, weight: 600, fill: 0, opticalSize: 24);
  }
}
